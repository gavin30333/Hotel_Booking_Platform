...
export const hotSearchTags: string[] = [
  '春熙路/太古里商业区', '成都东站', '宽窄巷子',
  '天府广场', '成都南站', '武侯区', '温江区',
  '成都天府国际机场', '成都双流国际机场', '文殊院'
];
    ...
    items: [
      {
        ...
        rank: 1,
        score: '4.7分',
        imageUrl: 'https://images.unsplash.com/photo-1575424909138-46b05e5919ec?w=500&q=80',
        type: 'hotel'
      },
      {
        id: '2',
        ...
        rank: 2,
        score: '4.8分',
        imageUrl: 'https://images.unsplash.com/photo-1513889961551-628c1e5e2ee9?w=500&q=80',
        type: 'hotel'
      },
      {
        id: '3',
        ...
        rank: 3,
        score: '4.7分',
        imageUrl: 'https://images.unsplash.com/photo-1504829857797-ddff29c27927?w=500&q=80',
        type: 'hotel'
      }
    ]
  }
