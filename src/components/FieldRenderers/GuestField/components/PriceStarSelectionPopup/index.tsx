...
export const PriceStarSelectionPopup: React.FC<Props> = ({
  ...
  const pricePresets = isInternational ? INTERNATIONAL_PRICE_PRESETS : DOMESTIC_PRICE_PRESETS;
          ...
          <View className='section'>
            ...
            <View className='slider-container'>
               ...
               >
                ...
                >
                  ¥{sliderValue[1] >= sliderMax ? `${sliderMax}+` : sliderValue[1]}
                </View>
              </View>
            ...
            <View className='price-inputs'>
                ...
                <View className='input-box'>
                    ...
                    <View className='input-wrapper'>
                        ...
                        />
                        {priceRange[1] >= maxLimit && <Text className='suffix'>以上</Text>}
                    </View>
                </View>
            </View>
