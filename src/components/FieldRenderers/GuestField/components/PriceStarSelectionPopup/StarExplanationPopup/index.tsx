        ...
        <ScrollView scrollY className='content'>
          <View className='section'>
            ...
            <View className='item'>
              ...
              <Text className='item-desc'>装修豪华，服务贴心，可提供较多的增值服务</Text>
            </View>
            ...
            <View className='item'>
              ...
              <Text className='item-desc'>装修高档，设施齐全，提供全面的优质服务</Text>
            </View>
            ...
            <View className='item'>
              ...
              <Text className='item-desc'>装修良好，设施用品齐全，提供良好的服务，酒店提供商务和早餐服务</Text>
            </View>
            ...
            <View className='item'>
              ...
              <Text className='item-desc'>酒店设有公共区域，提供基本设施服务</Text>
            </View>
          ...
          <View className='section'>
            ...
            <View className='item'>
              ...
              <Text className='item-desc'>酒店环境豪华、服务细致、品味精致，可提供较多高品质增值服务等。</Text>
            </View>
            ...
            <View className='item'>
              ...
              <Text className='item-desc'>酒店服务设施完善、环境舒适，部分分店可提供商务服务和休闲活动。</Text>
            </View>
            ...
            <View className='item'>
              ...
              <Text className='item-desc'>酒店提供宽敞的客房、齐全的便利设施、多样化的客房服务。</Text>
            </View>
            ...
            <View className='item'>
              ...
              <Text className='item-desc'>酒店设施基本完善，客房整洁，价格经济实惠。</Text>
            </View>
            ...
            <View className='item'>
              ...
              <Text className='item-desc'>酒店设备比较简单，只提供最基本的住宿条件</Text>
            </View>
          </View>
          ...
          <View className='section'>
            ...
            <View className='item'>
              ...
              <Text className='item-desc'>追求奢华体验，保证您的旅程值回票价</Text>
            </View>
            ...
            <View className='item'>
              ...
              <Text className='item-desc'>傲视同侪！领先同行的高级奢华酒店</Text>
            </View>
          </View>
          ...
          <View className='section'>
            ...
            <View className='item'>
              ...
              <Text className='item-desc'>环境豪华，提供高水平的服务、多样化休闲娱乐设施，客房设备完备且品质高档。</Text>
            </View>
            ...
            <View className='item'>
              ...
              <Text className='item-desc'>环境典雅，提供个性化服务，客房设备完善且品质较好。</Text>
            </View>
            ...
            <View className='item'>
              ...
              <Text className='item-desc'>环境温馨、舒适，提供基本服务，客房设备齐全且美观实用。</Text>
            </View>
            ...
            <View className='item'>
              ...
              <Text className='item-desc'>环境整洁、干净，提供基本的保障设施和生活用品，可能无服务接待人员。</Text>
            </View>
            ...
            <View className='item'>
              ...
              <Text className='item-desc'>装修简单、普通，仅提供最基本的住宿条件，可能无服务接待人员。</Text>
            </View>
          </View>
        </ScrollView>
      </View>
